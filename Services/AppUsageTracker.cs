...
namespace ScreenTracker1.Services
{
    public class AppUsageTracker
    {
     ...
     //   private int _userId;
        ...
        //    try
        //    {
        //        var screenshotResult = await _screenshot.CaptureAsync();
        ...
        //            content.Add(byteContent, "file", $"app_screenshot_{DateTime.Now:yyyyMMdd_HHmmss}.png");
        //            content.Add(new StringContent(_userId.ToString()), "userId");

        //            var response = await _httpClient.PostAsync("screenshot/upload", content);
